...
import org.throwable.server.exception.DuplicatedListenerContainerException;
import org.throwable.server.exception.ListenerBeanNotFoundException;
import org.throwable.support.BeanDefinitionRegisterAssistor;
...
public class ListenerContainerFactory implements BeanFactoryAware {
	...
	public SimpleMessageListenerContainer createListenerContainer(Class<?> listenerClass) throws Exception {
		...
		ExtendSimpleMessageListenerContainer container = new ExtendSimpleMessageListenerContainer(listenerClass, containerBeanName);
	...
	public class ExtendSimpleMessageListenerContainer extends SimpleMessageListenerContainer {
		...
		public ExtendSimpleMessageListenerContainer(Class<?> listenerClass, String containerBeanName) {
